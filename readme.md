...
Results for tiny dataset should be 640.000, for small 50.000.000 and for medium 900.000.000 (works, but the process always gets killed, we need ~24GB ram memory, cannot compress memory space)
