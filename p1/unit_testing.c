...
// compilation method: gcc -o unit_test unit_testing.c ./src/getColumn.c ./src/initArray.c ./src/reorderedColumn.c ./src/quicksort.c ./src/splitBucket.c ./src/result.c ./src/sortMergeJoin.c ./src/processRelation.c ./src/histogram.c ./src/psum.c -lcunit
